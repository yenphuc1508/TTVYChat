...
public class ServiceUser {
   ...
   public Model_Message register(Model_Register data) {
        ...
        if (data.getUserName() == null || data.getUserName().isEmpty() ||
            ...
            message.setMessage("Username and Password must not be empty");
            return message;
        }
        ...
        try {
            ...
            if (r.next()) {
                // User already exists
                message.setAction(false);
                message.setMessage("User already exists. Please choose a different username.");
            } else {
                ...
                // Set success message with user account data
